...
| 部落格 | 備註 |
| --- | --- |
| [不寫下來的東西都會被遺忘](https://blog.wei-lee.me/) | 我的另一個部落格，主要在寫技術文、書摘，還有各種有的沒的想法 |
...
| [Ivon 的部落格](https://ivonblog.com/) | |
| [SOCOTAKU](https://socotaku.org/) | |
| [花落時再見](https://shonm32.com/) | |
| [日名遊實｜一起探索最真實的日本](https://kalan.blog/) | |

## 社群夥伴

| 部落格 | 備註 |
| --- | --- |
| [Parker Chang's Web](https://www.parkerchang.life/) | 一直都很喜歡 Parker 大大的文字 |
| [Jerry Yang's Blog](https://blog.yangjerry.tw/) | |
| [Wei 自己寫點什麼](https://weiblog.me/) | BlogBlog 如果有兩個 Wei ，他通常是第一個（因為遲到仔我總是拖拖拉拉） |
...
| 部落格 | 備註 |
| --- | --- |
| [報導者 The Reporter](https://www.twreporter.org/) | 其實還是聽 [Podcast](https://www.twreporter.org/categories/podcast/the-real-story) 居多，但有時候會看一下 |
